package com.david.edspringbootapibuildproject.test;
import com.david.edspringbootapibuildproject.constant.ProjectConstant;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/edspringboot";
    ...
    private static final String AUTHOR = "David";//@author
