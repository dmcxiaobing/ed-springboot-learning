package com.david.edspringbootapibuildproject;
...
public class EdSpringbootApiBuildProjectApplication {

	public static void main(String[] args) {
		SpringApplication.run(EdSpringbootApiBuildProjectApplication.class, args);
	}
}
